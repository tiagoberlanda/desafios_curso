...
if forma_pagamento == 1:  
    ...
    total = preco_produto + juro_cartao
    quantidadeParcela = int(input('Em quantas parcelas?'))
    print('Essa condição de pagamento possui juros!')
    print('O valor a ser pago será de {}X de R${}'.format(quantidadeParcela, total / quantidadeParcela))
    print('O valor Total do produto na condição escolhida com juros é de R${}'.format(total))
else:
